...
public class PaymentConfig {
	...
	public static String vnpReturnurl = "http://localhost:9090/payment/success";
	public static String vnpTmnCode = "G91NJZT9";
	public static String vnpHashSecret = "CXXSWADOYXEHMGRCRKKRVWTQDEGKNDQC";
